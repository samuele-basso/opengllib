...
Load a model file and print basic statistics. Full postprocessing is applied unless the <tt>-r</tt> switch is specified. Sandbox output (<tt>assimp info ./test/models/3DS/mar_rifle.3ds</tt>):
