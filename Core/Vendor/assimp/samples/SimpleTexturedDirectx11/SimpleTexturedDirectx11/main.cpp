// ---------------------------------------------------------------------------
// Simple Assimp Directx11 Sandbox
...
using namespace AssimpSandboxs::SharedCode;
...
ID3D11SandboxrState *TexSandboxrState = nullptr;
	...
	LPWSTR /*lpCmdLine*/, int nCmdShow)
{
	...
	g_hwnd = CreateWindowEx(
		WS_EX_CLIENTEDGE,
		g_szClassName,
		" Simple Textured Directx11 Sandbox ",
		WS_OVERLAPPEDWINDOW,
...
void InitD3D(HINSTANCE /*hinstance*/, HWND hWnd)
{
	...
	if (dxgiFactory2)
	{
		...
		sd.SandboxDesc.Count = 4;
		sd.SandboxDesc.Quality = m4xMsaaQuality - 1;
	...
	descDepth.SandboxDesc.Count = 4;
	descDepth.SandboxDesc.Quality = m4xMsaaQuality - 1;
...
void RenderFrame(void)
{
	...
	devcon->PSSetSandboxrs(0, 1, &TexSandboxrState);
...
void InitGraphics()
{
	...
	hr = dev->CreateSandboxrState(&sampDesc, &TexSandboxrState);
	if (FAILED(hr))
